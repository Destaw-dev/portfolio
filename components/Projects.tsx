  ...
  const projects = [
    {
      ...
      imageUrl: "/listali.webp",
      highlights: Array.isArray(t.listali.highlights) ? [...t.listali.highlights] : undefined,
      priority: true,
    },
    {
      title: t.dashio.title,
      description: t.dashio.description,
      techStack: ["React", "Node.js", "Socket.io", "Express", "MongoDB"],
      liveUrl: "https://dashio-web.vercel.app/",
      imageUrl: "/dashio.webp",
      githubUrl: "https://github.com/Destaw-dev/Dashio",
      highlights: Array.isArray(t.dashio.highlights) ? [...t.dashio.highlights] : undefined,
    },
  ];
